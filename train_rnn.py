...
# Train separate RNN models for each metric
models = {}
history_logs = {}

for metric in ["Flow Rate (mL/sec)", "Current (mA)"]:
    print(f"Training RNN model for: {metric}")
...
plt.ylabel("Loss")
plt.legend()
plt.title("Training Loss for RNN Models")
plt.show()
...
print("RNN training completed. Models saved to rnn_models.pkl")
